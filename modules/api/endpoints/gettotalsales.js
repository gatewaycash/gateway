/**
 * GET /gettotalsales API endpoint
 * @author The Gateway Project Developers <hello@gateway.cash>
 * @file Defines a GET endpoint for /gettotalsales
 */
const mysql = require('mysql')
const url = require('url')

module.exports = function (req, res) {
  console.log('/gettotalsales requested')
  ...
  // search the database for the record
    ...
    var sql = 'select totalSales from users where APIKey = ? limit 1'
