    ...
    return (
      <div>
        <Paper className="paper">
          ...
          <p>
            The optional Payment ID property can be used to help you keep track
            of different payments made to your merchant account. For example, if
            ...
            payment IDs show up in the View Payments page, you'll know which
            orders have been paid for and are ready to ship.
          </p>
        </Paper>
        <Paper className="paper">
          ...
          <p>
            ...
            selected amount will also be deducted as well. All other funds go to
            your address.
          </p>
        </Paper>
      </div>
  ...
  render() {
    return (
      <div className="container">
        ...
        <div className="leftPanel">{this.renderMoreInfo()}</div>
        <div className="rightPanel">{this.renderSupportProject()}</div>
      </div>
    )
  }
}
