  ...
  render() {
    return (
      <Container>
        ...
        <Text>
          Your password protects the security of your account. Never share your
          password with anyone or use the same password across websites.
        </Text>
        <Text>
          ...
          <ul>
            ...
            <li>
              Not be a common word or phrase such as "password"
            </li>
            <li>
